...
export function MawkibRulesPrintContent({ data }: { data: MawkibRulesPrintData }) {
  return (
    <article className="mawkib-rules-sheet">
      <header className="mawkib-rules-sheet__hero">
        ...
        <p className="mawkib-rules-sheet__subtitle">
          لطفاً قبل از ورود، قوانین زیر را مطالعه فرمایید
        </p>
      </header>
      ...
      <section className="mawkib-rules-sheet__info">
        ...
        <InfoTile
          ...
          valueDir="ltr"
        />
        <InfoTile icon={<IconUser />} label="مسئول موکب" value={data.ownerFullName} />
      </section>
      ...
      <footer className="mawkib-rules-sheet__footer">
        رعایت قوانین موکب، موجب آرامش و نظم بیشتر برای همه زائران گرامی است.
      </footer>
    </article>
  );
}
  ...
  return (
    <>
      ...
      <button
        ...
        className={className ?? `${btnSecondary} w-full sm:w-auto disabled:cursor-not-allowed disabled:opacity-50`}
      >
        <svg
