...
const volunteerLinks = [
  { to: "/guest/honorary-volunteer/register", label: "ثبت‌نام خادم یاری" },
  { to: "/guest/honorary-volunteer/needs", label: "نیازمندی‌های موکب‌ها" },
  { to: "/guest/honorary-volunteer/track", label: "پیگیری درخواست خدمت" },
];
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-5">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-2 text-sm leading-7 text-slate-500">
              سامانه یکپارچه رزرو، مدیریت و پیگیری اسکان زائران در موکب‌های
              خدمات‌رسان.
            </p>
          </div>
          ...
          <FooterLinkGroup title="خادم یاری" links={volunteerLinks} />
        </div>
