...
export function MawkibMapSearchPage() {
  ...
  return (
    <div className="flex min-h-[calc(100dvh-8rem)] flex-col">
      ...
      <div className="relative min-h-[24rem] flex-1 overflow-hidden rounded-2xl border border-slate-200/80 bg-slate-100 shadow-sm sm:min-h-[28rem]">
        {isLoading ? (
          ...
          <>
            <MawkibMap mawkibs={mawkibs} country={country} mawkibCity={mawkibCity} />
            {mawkibs.length === 0 && (
