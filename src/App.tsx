...
import { GuestPilgrimCardPage } from "./pages/GuestPilgrimCardPage";
...
import { PilgrimsReportPage } from "./pages/reports/PilgrimsReportPage";
import { MawkibOwnersReportPage } from "./pages/reports/MawkibOwnersReportPage";
        ...
        <BrowserRouter>
          <Routes>
            <Route element={<PublicLayout />}>
              ...
              <Route
                path="/guest/reserve/guide"
                element={<PilgrimReservationGuidePage />}
              />
              <Route path="/guest/track" element={<TrackReservationPage />} />
              <Route path="/guest/pilgrim-card" element={<GuestPilgrimCardPage />} />
              <Route path="/guest/mawkibs" element={<GuestMawkibsPage />} />
              <Route
                path="/guest/mawkibs/:id"
                element={<GuestMawkibDetailPage />}
              />
              <Route
                path="/guest/mawkib-owner/register"
                element={<MawkibOwnerRegisterPage />}
              />
              <Route
                path="/guest/mawkib-owner/guide"
                element={<MawkibRegistrationGuidePage />}
              />
              <Route
                path="/guest/honorary-volunteer"
                element={
                  <Navigate to="/guest/honorary-volunteer/register" replace />
                }
              />
              <Route
                path="/guest/honorary-volunteer/register"
                element={<HonoraryVolunteerRegisterPage />}
              />
              <Route
                path="/guest/honorary-volunteer/success"
                element={<HonoraryVolunteerSuccessPage />}
              />
              <Route
                path="/guest/honorary-volunteer/needs"
                element={<HonoraryVolunteerNeedsPage />}
              />
              <Route
                path="/guest/honorary-volunteer/track"
                element={<HonoraryVolunteerTrackPage />}
              />
              <Route path="/guest/pilgrims" element={<PilgrimPortalPage />} />
              <Route
                path="/guest/mawkib-owners"
                element={<MawkibOwnerPortalPage />}
              />
            ...
            <Route element={<ProtectedRoute />}>
              <Route element={<AdminLayout />}>
                ...
                >
                  ...
                  <Route
                    path="/mawkibs/map"
                    element={<MawkibMapSearchPage />}
                  />
                  <Route
                    path="/mawkibs/:id/rules"
                    element={<MawkibRulesPrintPage />}
                  />
                  <Route
                    path="/mawkibs/:id/view"
                    element={<MawkibViewDetailPage />}
                  />
                  <Route
                ...
                <Route
                  element={
                    <RoleRoute
                      allowedRoles={["Admin", "MawkibOwner", "Pilgrim"]}
                    />
                  }
                >
                ...
                <Route element={<RoleRoute allowedRoles={["MawkibOwner"]} />}>
                  <Route
                    path="/feedback/inbox"
                    element={<OwnerFeedbackInboxPage />}
                  />
                </Route>
                <Route element={<RoleRoute allowedRoles={["Admin"]} />}>
                  <Route path="/users" element={<UsersPage />} />
                  <Route path="/admin/crons" element={<CronsPage />} />
                  <Route
                    path="/admin/capacity"
                    element={<CapacityManagementPage />}
                  />
                  <Route
                    path="/users/mawkib-owners"
                    element={<MawkibOwnersPage />}
                  />
                  <Route
                    path="/users/honorary-servants"
                    element={<HonoraryServantsPage />}
                  />
                </Route>
                <Route
                  element={
                ...
                >
                  ...
                  />
                  <Route
                    path="/honorary-volunteers/new"
                    element={<MawkibNeedRegisterPage />}
                  />
                  <Route
                    path="/reports/pilgrims"
                    element={<PilgrimsReportPage />}
                  />
                  <Route
                    path="/reports/mawkibs"
                    element={<MawkibsReportPage />}
                  />
                  <Route
                ...
                <Route element={<RoleRoute allowedRoles={["Admin"]} />}>
                  <Route
                    path="/reports/mawkib-owners"
                    element={<MawkibOwnersReportPage />}
                  />
                </Route>
              </Route>
            </Route>
